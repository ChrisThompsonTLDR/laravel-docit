...
<body id="hyde-docs" class="bg-white dark:bg-zinc-900 dark:text-zinc-100 min-h-screen w-screen relative overflow-x-hidden overflow-y-auto"
    ...
    <main id="content" class="dark:bg-zinc-900 min-h-screen bg-white absolute top-16 md:top-0 w-screen md:left-64 md:w-[calc(100vw_-_16rem)] lg:left-72 lg:w-[calc(100vw_-_18rem)] xl:left-80 xl:w-[calc(100vw_-_20rem)] print:top-0">

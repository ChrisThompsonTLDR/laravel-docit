...
<article itemprop="item" itemscope itemtype="https://schema.org/BlogPosting">
    ...
    <header>
        <a href="{{ $post->getRoute() }}" class="block w-fit">
            <h2 itemprop="headline" class="text-2xl font-bold text-zinc-700 hover:text-zinc-900 dark:text-zinc-200 dark:hover:text-white transition-colors duration-75">
    ...
    <footer>
        <a href="{{ $post->getRoute() }}" class="text-emerald-500 hover:underline font-medium">
            Read post
        </a>
    </footer>
</article>
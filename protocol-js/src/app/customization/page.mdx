...
Docit adds a Markdown extension for VitePress-style custom containers. Use `card` and `` for card layouts:
...
- **[Quick Start](/quick-start)** – Build, output to `docs/`, and deploy.
